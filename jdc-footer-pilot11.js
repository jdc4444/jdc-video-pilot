...
(function () {
  ...
  function installProjectSpacing() {
    ...
    if (!document.getElementById("jdc-project-spacing-styles")) {
      ...
      style.textContent = [
        ...
        ".jdc-project-spacing .jdc-project-title-block,.jdc-project-spacing .jdc-project-body-block{transform:translateY(var(--jdc-project-spacing-shift,0px))!important}",
        ".jdc-project-spacing .jdc-project-title-block h1,.jdc-project-spacing .jdc-project-title-block h2,.jdc-project-spacing .jdc-project-title-block h3{margin-top:0!important;margin-left:0!important;white-space:normal!important;overflow-wrap:break-word!important}",
        "@media(min-width:768px){.jdc-project-spacing .jdc-project-title-block h1,.jdc-project-spacing .jdc-project-title-block h2,.jdc-project-spacing .jdc-project-title-block h3{width:115%!important;margin-left:-25.875%!important;transform:scale(.55)!important;transform-origin:center top!important}.jdc-project-spacing .jdc-project-body-block .sqs-block-html{box-sizing:border-box!important;padding-left:clamp(20px,2.25vw,36px)!important}}",
        "@media(max-width:767px){.jdc-project-spacing .jdc-project-title-block,.jdc-project-spacing .jdc-project-body-block{transition:none!important}.jdc-project-spacing .jdc-project-title-block h1,.jdc-project-spacing .jdc-project-title-block h2,.jdc-project-spacing .jdc-project-title-block h3{width:100%!important;transform:none!important}}"
      ].join("");
    ...
    function schedule() {
      ...
      requestAnimationFrame(function () {
        ...
        var currentTitleShift = pixel(titleStyle.getPropertyValue("--jdc-project-spacing-shift"));
        var currentBodyShift = pixel(bodyStyle.getPropertyValue("--jdc-project-spacing-shift"));
        var topDelta = headerRect.bottom + gap - leadRect.top;
        var titleDelta = leadRect.bottom + gap - titleRect.top;
        var bodyDelta;
        if (desktop) {
          bodyDelta = leadRect.bottom + gap - bodyRect.top;
        } else {
          var futureTitleBottom = titleRect.bottom + titleDelta;
          bodyDelta = Math.max(0, futureTitleBottom + 16 - bodyRect.top);
        }

        setPixel(engine, "--jdc-project-top-shift", currentTopShift + topDelta);
        setPixel(title, "--jdc-project-spacing-shift", currentTitleShift + titleDelta);
        setPixel(body, "--jdc-project-spacing-shift", currentBodyShift + bodyDelta);
  ...
  window.__JDC_SMART_VIDEO__ = {
    version: "adaptive-prefetch-pilot-11-project-edge-rhythm",
    states: states,
    activate: activate,
    unload: unload,
