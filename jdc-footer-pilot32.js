(function () {
  ...
  function installPolymarketFlowFix() {
    ...
    if (document.getElementById("jdc-polymarket-flow-fix32")) return;

    var style = document.createElement("style");
    style.id = "jdc-polymarket-flow-fix32";
    style.textContent = [
      ...
      ".jdc-polymarket-gallery-section>.content-wrapper>.jdc-polymarket-gallery-grid{display:grid!important;width:100%!important;max-width:none!important;height:auto!important;min-height:0!important;align-items:start!important;align-content:start!important;grid-auto-rows:auto!important;margin-top:0!important;margin-bottom:calc(clamp(20px,2.2vw,34px) + var(--jdc-polymarket-grid-shift,0px))!important;translate:0 var(--jdc-polymarket-grid-shift,0px)!important}",
    ...
    document.documentElement.setAttribute("data-jdc-polymarket-flow-fix", "pilot32");
  }
  ...
  function alignPolymarketGallery() {
    ...
    requestAnimationFrame(function () {
      ...
      var currentShift = Number.parseFloat(getComputedStyle(grid).getPropertyValue("--jdc-polymarket-grid-shift")) || 0;
      ...
      if (Math.abs(desiredShift - currentShift) > 0.1) {
        grid.style.setProperty("--jdc-polymarket-grid-shift", Math.round(desiredShift * 100) / 100 + "px");
      }
  ...
  function loadPilot27Core() {
    ...
    if (document.querySelector('script[data-jdc-pilot32-core="pilot27"]')) return;

    var core = document.createElement("script");
    core.src = CORE_URL;
    core.async = false;
    core.crossOrigin = "anonymous";
    core.setAttribute("data-jdc-pilot32-core", "pilot27");
    core.addEventListener("load", function () {
      if (document.body) document.body.setAttribute("data-jdc-footer-release", "pilot32");
      schedulePolymarketAlignment();
    }, { once: true });
