(function () {
  ...
  function installPolymarketFlowFix() {
    ...
    if (document.getElementById("jdc-polymarket-flow-fix29")) return;

    var style = document.createElement("style");
    style.id = "jdc-polymarket-flow-fix29";
    style.textContent = [
      ".jdc-polymarket-gallery-section>.content-wrapper{display:block!important;width:100%!important;min-height:0!important}",
      ".jdc-polymarket-gallery-section>.content-wrapper>.fluid-engine{display:grid!important;width:100%!important;max-width:none!important;min-height:0!important;margin-bottom:var(--jdc-project-top-shift,0px)!important}",
    ...
    document.documentElement.setAttribute("data-jdc-polymarket-flow-fix", "pilot29");
  }

  function loadPilot27Core() {
    if (window.__JDC_SMART_VIDEO__) return;
    if (document.querySelector('script[data-jdc-pilot29-core="pilot27"]')) return;

    var core = document.createElement("script");
    core.src = CORE_URL;
    core.async = false;
    core.crossOrigin = "anonymous";
    core.setAttribute("data-jdc-pilot29-core", "pilot27");
    core.addEventListener("load", function () {
      if (document.body) document.body.setAttribute("data-jdc-footer-release", "pilot29");
    }, { once: true });
