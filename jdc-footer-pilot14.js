...
(function () {
  ...
  function register(shell, config, kind) {
    ...
    var state = { shell: shell, stage: stage, config: config, kind: kind, order: states.size, video: null, hls: null, loading: false, starting: false, startupTimer: null, startupOutcome: "poster", controls: null, retryCount: 0, retryTimer: null, pilotFailed: false, usingPilot: false };
  ...
  window.__JDC_SMART_VIDEO__ = {
    version: "adaptive-prefetch-pilot-14-progressive-gallery-startup",
    states: states,
    activate: activate,
    unload: unload,
