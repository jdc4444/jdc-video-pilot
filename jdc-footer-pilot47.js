(function () {
  ...
  if (window.__JDC_PILOT47__) return;
  window.__JDC_PILOT47__ = true;
  ...
  function observeHomepage() {
    ...
    window.__JDC_HOMEPAGE_ORDER_OBSERVER47__ = observer;
  }

  function loadCore() {
    if (document.querySelector('script[data-jdc-pilot47-core="pilot42"]')) return;
    var core = document.createElement("script");
    core.src = CORE_URL;
    core.async = false;
    core.crossOrigin = "anonymous";
    core.setAttribute("data-jdc-pilot47-core", "pilot42");
