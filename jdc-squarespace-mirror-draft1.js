(function () {
  ...
  function installStyles() {
    ...
    style.textContent = [
      ...
      "html[data-jdc-squarespace-mirror-page='onepage'] #header{position:fixed!important;top:0!important;right:0!important;left:0!important;width:100%!important;z-index:9999!important;transform:none!important}",
      ...
      ".jdc-mirror-onepage-brand,.jdc-mirror-onepage-contact{position:relative;z-index:2;display:block;margin:0;color:#fff;text-decoration:none;text-shadow:0 1px 8px rgba(0,0,0,.3);white-space:nowrap}",
