(function () {
  ...
  function installStyles() {
    ...
    style.textContent = [
      ...
      ".jdc-mirror-onepage-filter{appearance:none;margin:0;padding:0 0 1px;border:0;border-bottom:1px solid transparent;border-radius:0;background:transparent;color:inherit;font:300 12px/19.2px Poppins,Arial,Helvetica,sans-serif;letter-spacing:normal;text-decoration:none;text-shadow:none;text-transform:none;cursor:pointer;opacity:1}",
